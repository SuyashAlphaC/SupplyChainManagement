    ...
    <div className="max-w-md w-full mx-auto  md:rounded-2xl p-4 md:p-8 shadow-input bg-[#708090] z-[10] p-2 rounded-[20px]">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
          <LabelInputContainer className={"mb-4"}>
            ...
            <Input id="name" placeholder="Your Name" type="text" className="bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white"/>
          </LabelInputContainer>
        <LabelInputContainer className="mb-4">
        ...
        <Label htmlFor="userIntroduction">Tell Us A Bit About Yourself</Label>
        <textarea
            id="userIntroduction"
      ...
      <div className='text-center font-bold'>
        ...
        <Link to="/login">
            <span className="text-white cursor-pointer text-center font-bold"> Login </span>
        </Link>
      </div>
    </div>
